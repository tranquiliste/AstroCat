...
class SettingsDialog(QtWidgets.QDialog):
    ...
    def __init__(self, config: Dict, parent: Optional[QtWidgets.QWidget] = None) -> None:
        ...
        astrometry_help = QtWidgets.QLabel(tr("settings.astrometry.setup_help"))
        astrometry_help.setWordWrap(True)
        astrometry_help.setOpenExternalLinks(True)
        ...
        astrometry_form.addRow("", astrometry_help)
